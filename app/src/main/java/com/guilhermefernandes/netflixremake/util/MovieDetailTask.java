...
public class MovieDetailTask extends AsyncTask<String, Void, MovieDetail> {
    ...
    private MovieDatailLoader movieDatailLoader;

    public MovieDetailTask(Context context) {
        this.context = new WeakReference<>(context);
    }

    public void setMovieDatailLoader(MovieDatailLoader movieDatailLoader) {
        this.movieDatailLoader = movieDatailLoader;
    }
    ...
    protected void onPostExecute(MovieDetail movieDetail) {
        ...
        if (movieDatailLoader != null)
            movieDatailLoader.onResult(movieDetail);
    }
    ...
    public interface MovieDatailLoader{
